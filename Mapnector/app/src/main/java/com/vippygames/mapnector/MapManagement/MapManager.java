package com.vippygames.mapnector.MapManagement;
...
import com.vippygames.mapnector.FirebaseCommunication.FirebaseLocationSystem;
...
public class MapManager implements View.OnClickListener {
    ...
    public MapManager(Activity activity, GoogleMap googleMap, FirebaseHelper FBhelper,
        ...
        handler = new Handler(msg -> { //msg.what == 11 means update with map, 22 means just clear map
            googleMap.clear();
            if(msg.what == 11) {
                this.drawMapData();
            }
